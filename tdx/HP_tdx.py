...
def get_security_quotes(code='002362'):
    scode=code
    nMarket = get_market(code)
    smarket=nMarket    
...
def szStockList():
    base = GetSecurityList(0)
    base=base.loc[base.code.str.startswith('300')]
    return base
...
if __name__ == '__main__':
    ...
    latest=get_security_quotes('002424')
    print(latest)

    aa=get_security_quotes('002362')
    print(aa)

    bb=get_security_quotes('601778')
    print(bb)

    cc=get_security_quotes('603121')
    print(cc)

    # df=szStockList()
    # df=get_security_bars(5,1,'600460',0,200)
    #
    #
    # print(df)
    # print(df)
    ...
    # print(df2)
    # df3=get_security_bars(nCategory=4,nMarket = 1,code='300182',nStart=0, nCount=7)
    # print(df3)
